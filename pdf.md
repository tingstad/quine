...
Used while writing [quine.pdf](quine.pdf)
...
https://pdfa.org/the-smallest-possible-valid-pdf/ has some nice info

```
git clone --depth 1 https://github.com/pdfcpu/pdfcpu.git \
  && cd pdfcpu && docker build -t pdfcpu
docker run -it -v ./:/app:ro pdfcpu validate -v quine.pdf
